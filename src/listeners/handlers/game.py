...
def handler(say, context, event):
  ...
  random_pick = rock_scissors_papers[random.range(0,3)]
  ...
  if (text_input == "가위" and random_pick == "보") or (text_input == "바위" and random_pick == "가위") or (text_input == "보" and random_pick == "바위"):
    say("당신의 승리")
  elif (text_input == "가위" and random_pick == "주먹") or (text_input == "바위" and random_pick == "보") or (text_input == "보" and random_pick == "가위"):
    say("당신의 패배")
  else:
    say("무승부")